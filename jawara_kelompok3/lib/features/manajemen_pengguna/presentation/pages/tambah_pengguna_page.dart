            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextFormField("Nama Lengkap", "Masukkan nama lengkap",
                      controller: _namaController),
                  _buildTextFormField("Email", "Masukkan email",
                      controller: _emailController,
                      keyboardType: TextInputType.emailAddress),
                  _buildTextFormField("NIK / Nomor Identitas", "Masukkan NIK",
                  ...
                  _buildTextFormField(
                      "Konfirmasi Password", "Masukkan kembali password",
                      controller: _confirmPasswordController, isPassword: true),
                  _buildDropdownField("Role", "-- Pilih Role --", _selectedRole,
                      _roleList, (val) => setState(() => _selectedRole = val)),
                  _buildDropdownField(
                      "Jenis Kelamin",
                      "-- Pilih Jenis Kelamin --",
