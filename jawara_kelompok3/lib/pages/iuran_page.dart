...
class IuranPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, String>> dataIuran = [
      {"no": "1", "nama": "Mingguan", "jenis": "Iuran Khusus", "nominal": "Rp 10,000"},
      {"no": "2", "nama": "Agustusan", "jenis": "Iuran Khusus", "nominal": "Rp 15,000"},
    ];
                      ...
                      cells: [
                        ...
                        DataCell(
                          IconButton(
                            ...
                            onPressed: () {
                              Navigator.pushNamed(context, '/detail', arguments: row);
                            },
                          ),
                        ),
                      ],
